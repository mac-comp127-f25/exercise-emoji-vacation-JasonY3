...
public class Emojis {
    private static final Color
        ...
        EYE_COLOR = new Color(000),
        EYE_OUTLINE_COLOR = new Color(000),
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        Ellipse leftEye = (createEye(eyeSize, eyeSize));
        leftEye.setCenter(eyeSize * 2.5, eyeSize * 2.5);
        group.add(leftEye);

        Ellipse rightEye = (createEye(eyeSize, eyeSize));
        rightEye.setCenter(eyeSize * 5.5, eyeSize * 2.5);
        group.add(rightEye);
